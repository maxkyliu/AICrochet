# grammar-terminator Specification

## Purpose
Define when and how the crochet grammar terminates a part, including closure instructions, stuffing notes, and early-exit on decreasing-to-minimum, so every 3D part ends with clear instructions a crocheter can follow.
